...
namespace Cinema.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,Title,Price,Date,Genre")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,Title,Price,Date,Genre")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
